...
SetGeoLayerViewEventHandler(GeoLayerViewID="ContinentalDivideLayerView",EventType="hover",Name="Hover event",Description="Hover event configuration",Properties="eventConfigPath:layers/continental-divide-event-config.json")
SetGeoLayerViewEventHandler(GeoLayerViewID="ContinentalDivideLayerView",EventType="click",Name="Click event",Description="Click event configuration",Properties="eventConfigPath:layers/continental-divide-event-config.json")
# = = = = = = = = = =
...
# Works for 2023, based on basin information websites, allows more than 1000 features so use a geometry of the entire US.
ReadGeoLayerFromGeoJSON(InputFile="https://services3.arcgis.com/T4QMspbfLg3qTGWY/ArcGIS/rest/services/WFIGS_Interagency_Perimeters_YearToDate/FeatureServer/0/query?geometry=-126.0%2C24.5%2C-65.05%2C49.5&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelContains&outFields=*&geometryPrecision=5&f=geojson",GeoLayerID="WildfirePerimetersLayer",Name="US Wildfire Perimeters",Description="US wildfire perimeters web service")
# ----------
# Start old...
# Include mainland and Alaska, however, service seems to be capped at 1000 features
#ReadGeoLayerFromGeoJSON(InputFile="https://services3.arcgis.com/T4QMspbfLg3qTGWY/ArcGIS/rest/services/Public_Wildfire_Perimeters_View/FeatureServer/0/query?geometry=-170.0%2C24.5%2C-64.0%2C71.5&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelContains&outFields=*&geometryPrecision=5&f=geojson",GeoLayerID="WildfirePerimetersLayer",Name="US Wildfire Perimiters",Description="US wildfire perimeters web service")
# Include mainland and Alaska and Hawaii, however, service seems to be capped at 1000 features
# ReadGeoLayerFromGeoJSON(InputFile="https://services3.arcgis.com/T4QMspbfLg3qTGWY/ArcGIS/rest/services/Public_Wildfire_Perimeters_View/FeatureServer/0/query?geometry=-170.0%2C17.5%2C-64.0%2C71.5&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelContains&outFields=*&geometryPrecision=5&f=geojson",GeoLayerID="WildfirePerimetersLayer",Name="US Wildfire Perimiters",Description="Colorado wildfire perimeters web service")
...
#ReadGeoLayerFromGeoJSON(InputFile="https://opendata.arcgis.com/datasets/6bd5dd4e93154f6fae0de1f2c82d95bf_0.geojson",GeoLayerID="WildfirePerimetersLayer",Name="US Wildfire Perimiters",Description="US wildfire perimeters web service")
# The following no longer works (commented out on 2021-07-19):
# - TODO smalers 2021-07-19 remove when the above tests out
#ReadGeoLayerFromGeoJSON(InputFile="https://opendata.arcgis.com/datasets/5da472c6d27b4b67970acc7b5044c862_0.geojson",GeoLayerID="WildfirePerimetersLayer",Name="US Wildfire Perimiters",Description="US wildfire perimeters web service")
# ... end old.
AddGeoLayerViewToGeoMap(GeoLayerID="WildfirePerimetersLayer",GeoLayerViewID="WildfirePerimetersLayerView",Name="US Wildfire Perimeters",Description="US year to date wildfire perimeters from the National Interagency Fire Center",Properties="docPath:layers/wildfire-perimeters.md")
...
# Layers
#
CopyFile(SourceFile="layers/continental-divide-event-config.json",DestinationFile="${MapFolder}/layers/continental-divide-event-config.json")
#
